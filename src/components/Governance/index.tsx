      ...
      <div className={s.card} key="bounty">
        <div className={s.textWrapper}>
          <div>
            ...
            <p>
              AnAi is a community-driven decentralized protocol delivering best-in-class
        ...
        <div className={s.rings}>
          <div className={s.proposalsInfo}>
            ...
            <span className={s.proposals}>AnAi Improvement Proposals Executed and counting</span>
          </div>
        </div>
      </div>
    </Container>
